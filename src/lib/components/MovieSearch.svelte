...
<section>
  <input
    ...
    class="w-full px-3 py-2 bg-transparent border-b border-mute font-serif-light text-base transition-all duration-300 ease-elastic focus:outline-none focus:border-ink focus:scale-[1.03] focus:tracking-wider"
  />
